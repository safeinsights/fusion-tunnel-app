...
// Local-API bodies are plaintext queries and responses; anything above this travels through
// the blob path once encrypted, but the RC still has to hand it over in one request.
